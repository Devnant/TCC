...
- projeto: variável categórico que indica como foi desenvolvido o projeto pedagógico da escola, sendo (A) com participação da equipe escolar, (B) sem participação da equipe escolar e (C) não há projeto (a ser elaborado com referência na coluna TX_RESP_Q032 de TS_DIRETOR em Fontes.RData).
